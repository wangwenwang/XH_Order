//
//  OutputReturnConfirmViewController.m
//  Order
//
...
@interface OutputReturnConfirmViewController ()<UITableViewDelegate, UITableViewDataSource, ConfirmOrderTableViewCellDelegate, AddGiftsServiceDelegate, Store_StockOutConfirmServiceDelegate, LMPickerViewDelegate>
...
// 门店名称
@property (weak, nonatomic) IBOutlet UILabel *PARTY_NAME_send;

// 联系人名
@property (weak, nonatomic) IBOutlet UILabel *CONTACT_PERSON_send;

// 联系方式
@property (weak, nonatomic) IBOutlet UILabel *CONTACT_TEL_send;

// 地址详情
@property (weak, nonatomic) IBOutlet UILabel *ADDRESS_INFO_send;
...
static CGFloat g_sumInfoSuperViewHeight_b = 0;


@implementation OutputReturnConfirmViewController
...
- (void)refreshCollectDada {
    ...
    if([_promotionOrder.MJ_REMARK isEqualToString:@""] || [_promotionOrder.MJ_REMARK isEqualToString:@"+|+"]) {
        ...
        if(!g_sumInfoSuperViewHeight_b) {
            
            _sumInfoSuperViewHeight.constant -= 30;
            g_sumInfoSuperViewHeight_b = _sumInfoSuperViewHeight.constant;
        }
    } else {
